    ...
    <div className="font-[family-name:var(--font-geist-sans)] pt-8 min-h-screen bg-[#0a0a0a]">
      <main className="max-w-2xl p-4 mx-auto">
        ...
        <p className="text-[16px] leading-[28px] text-[#adadad]">
          I&apos;m 17 y/o high school student. I love building stuff and solving problems. I enjoy building beautiful interactive websites with next js. If im not coding im probably out in the sun,
